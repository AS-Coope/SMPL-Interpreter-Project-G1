...
With foundational code developed and implemented by Professor D. Coore, the aim was to create an interpreter for the language SMPL based on its specification. Despite the course coming to an end, this project was very interesting and as such, diving deeper into designing and implementing more functionality for the language is a burning desire. 
<p>
